...
patJetsAK5PFNoMuon.checkOverlaps.muons.deltaR            = cms.double(0.2) #changed from 0.1
...
patJetsAK5PFNoMuon.checkOverlaps.electrons.src           = cms.InputTag('patElectronsPF')
patJetsAK5PFNoMuon.checkOverlaps.tkIsoElectrons.src      = cms.InputTag('patElectronsPF')
patJetsAK5PFNoMuon.checkOverlaps.photons.src             = cms.InputTag('patPhotonsRA2')
